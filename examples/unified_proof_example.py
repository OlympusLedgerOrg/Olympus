...
def main():
    ...
    for record_type, record_id, version in records:
        ...
        value_hash = hash_bytes(f"content-of-{record_id}".encode('utf-8'))
    ...
    print(f"   Request: document/invoice-2024-001")
    ...
    print(f"   Request: document/nonexistent-doc")
    print(f"   Response: exists={response2['exists']}")
    print(f"   HTTP Status: 200 OK (not 500!)")
    print()
