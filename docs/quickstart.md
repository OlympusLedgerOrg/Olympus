...
> `setup_circuits.sh` as a historical artifact stem. The HTTP identifier is
> `unified_section_commitment_inclusion_root`; the R1CS proves a structured
> section commitment and inclusion, not canonicalization or signatures. Its
