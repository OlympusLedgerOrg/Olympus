...
| `OLYMPUS_INGEST_SIGNING_KEY` | Ed25519 shard/redaction/snapshot signing | Env var only, never written to disk | Manual procedure below |
...
```json
[{ "x": "<old_x_decimal>", "y": "<old_y_decimal>", "valid_until": 1767225600 }]
```
