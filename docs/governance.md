...
Olympus is licensed under **Apache License 2.0** for all components. This provides:
- Strong patent protection for cryptographic implementations
- Enterprise-friendly licensing terms
- Complete transparency and auditability of the protocol

The open-source model enables:
- Independent verification of all cryptographic primitives
- Community-driven security review and hardening
- Collaborative protocol development and enhancement
- No vendor lock-in or proprietary barriers
