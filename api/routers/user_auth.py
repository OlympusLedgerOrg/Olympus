...
_REGISTER_RATE_LIMIT_MINUTE_CAPACITY = float(
    os.environ.get("OLYMPUS_REGISTER_RATE_LIMIT_MINUTE_CAPACITY", "1")
)
_REGISTER_RATE_LIMIT_MINUTE_REFILL = float(
    os.environ.get("OLYMPUS_REGISTER_RATE_LIMIT_MINUTE_REFILL", str(1.0 / 60.0))
)
_REGISTER_RATE_LIMIT_DAY_CAPACITY = float(
    os.environ.get("OLYMPUS_REGISTER_RATE_LIMIT_DAY_CAPACITY", "10")
)
_SECONDS_PER_DAY = 86_400.0
_REGISTER_RATE_LIMIT_DAY_REFILL = float(
    os.environ.get(
        "OLYMPUS_REGISTER_RATE_LIMIT_DAY_REFILL",
        str(_REGISTER_RATE_LIMIT_DAY_CAPACITY / _SECONDS_PER_DAY),
    )
)
