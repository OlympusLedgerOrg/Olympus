...
description: >
  ...
  (v0.9.x Rust/Tauri desktop). Use whenever writing new code, reviewing code,
...
# Olympus Dev Standards (v0.9.x)

Senior engineering judgment for the Olympus cryptographic ledger.
GitHub: `OlympusLedgerOrg/Olympus`. Source of truth for specifics: `CLAUDE.md`.
...
└── .claude/skills/       ← crypto-guardrails, zk-verifiers, this skill
```
