...
/// Constants for domain separation — must match `olympus_crypto`
/// (`crates/olympus-crypto/src/lib.rs`; `LEAF_PREFIX` is retained there as a
/// pinned legacy marker for the binary-Merkle helper vectors)
