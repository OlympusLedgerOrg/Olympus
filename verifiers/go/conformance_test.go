...
// SsmfExistenceProofVec mirrors a single ssmf_existence_proof vector in vectors.json.
type SsmfExistenceProofVec struct {
...
// SsmfNonExistenceProofVec mirrors a single ssmf_nonexistence_proof vector in vectors.json.
type SsmfNonExistenceProofVec struct {
	Description   string   `json:"description"`
	Key           string   `json:"key"`
	RootHash      string   `json:"root_hash"`
	Siblings      []string `json:"siblings"`
