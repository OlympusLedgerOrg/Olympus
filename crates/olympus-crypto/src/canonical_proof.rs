...
/// Maximum serialized canonicalization receipt accepted by Olympus (16 MiB).
pub const MAX_CANONICAL_RECEIPT_BYTES: usize = 16 * 1024 * 1024;
/// Per-proof zkVM user-cycle ceiling. The committed adversarial cycle report
/// peaks at 744,183,696 user cycles, leaving roughly 30.7% of the ceiling unused.
...
mod tests {
    ...
    fn size_limits_accept_the_boundary_and_reject_the_next_byte() {
        ...
        assert_eq!(MAX_CANONICAL_RECEIPT_BYTES, 16 * 1024 * 1024);
