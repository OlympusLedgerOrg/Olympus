...
from protocol.merkle import MerkleTree, MerkleProof, verify_proof, merkle_leaf_hash
...
def test_canonical_position_normalization_in_merkle_proof_init():
    ...
    for i, ((_, orig_pos), (_, norm_pos)) in enumerate(zip(proof.siblings, normalized_proof.siblings)):
