...
def test_event_id_prevents_field_injection() -> None:
    ...
    def legacy_separator_event_id(shard_id: str, header_hash: str) -> str:
    ...
    colliding_legacy = legacy_separator_event_id("X|Y", "Z")
    assert colliding_legacy == legacy_separator_event_id("X", "Y|Z")
