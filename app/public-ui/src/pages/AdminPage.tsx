      ...
      <div style={{ display: "flex", gap: "0.5rem" }}>
        <code
          style={{
            ...
            fontSize: mono ? "0.7rem" : "0.78rem",
            wordBreak: "break-all",
            lineHeight: 1.5,
            color: "#00ff41",
            fontFamily: mono ? "var(--font-terminal)" : "inherit",
          }}
        >
          {value}
        </code>
...
export default function AdminPage() {
  ...
  const [scopes, setScopes] = useState<Set<string>>(
    new Set(["read", "verify", "ingest", "commit", "write"]),
  );
    ...
    <div style={{ maxWidth: "660px", margin: "0 auto" }}>
      ...
      {myKey && (
        ...
        >
          ...
          <div style={{ fontSize: "0.6rem", color: "rgba(0,255,65,0.35)", lineHeight: 1.5 }}>
            Pre-filled on the LEDGER tab. If you need to regenerate, reset your account from the
            startup screen.
          </div>
        </div>
      )}
      ...
      >
        ...
        <div style={{ marginBottom: "1rem" }}>
          ...
          <div
            style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) auto", gap: "0.6rem" }}
          >
            <input
              type="text"
              value={password}
