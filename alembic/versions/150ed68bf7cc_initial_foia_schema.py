...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "level",
            sa.Enum("MUNICIPAL", "COUNTY", "STATE", "FEDERAL", name="agency_level"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "request_type",
            sa.Enum("NC_PUBLIC_RECORDS", "FEDERAL_FOIA", "FERPA", name="request_type"),
            nullable=False,
        ),
        sa.Column(
            "status",
        ...
        sa.Column(
            "priority",
            sa.Enum(
                "STANDARD", "EXPEDITED_SAFETY", "EXPEDITED_PUBLIC_INTEREST", name="request_priority"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "UNDER_REVIEW", "UPHELD", "OVERTURNED", "DENIED_ON_APPEAL", name="appeal_status"
            ),
            nullable=False,
        ),
        sa.Column("commit_hash", sa.String(length=64), nullable=False),
